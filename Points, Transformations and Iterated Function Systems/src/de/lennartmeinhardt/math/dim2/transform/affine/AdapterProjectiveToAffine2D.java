...
import de.lennartmeinhardt.math.dim2.transform.projective.ProjectiveHolder2D;

public interface AdapterProjectiveToAffine2D extends ProjectiveHolder2D, AffineHolder2D {
